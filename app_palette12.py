...
st.set_page_config(
    page_title="Workforce Intelligence Command - Palette 12",
    page_icon="⚡",
    layout="wide",
    initial_sidebar_state="collapsed"
)

# Custom Palette 12 Color System
# Main background: #F7F7F8 | Alternate section: #EEEFFA | Cards: #E1E4F5 | Main heading: #171528
# Body text: #635167 | Navigation / Primary button: #2B2543 | Button text: #FFFFFF
# Secondary button / Links: #62579B | Borders: #D5D8E9 | Active state: #7C86B3
st.markdown("""
<style>
    ...
    .stApp {
        ...
        background-image: 
            radial-gradient(at 50% 0%, #EEEFFA 0%, transparent 75%),
            radial-gradient(at 0% 100%, #F7F7F8 0px, transparent 50%),
            radial-gradient(at 100% 100%, rgba(238, 239, 250, 0.6) 0px, transparent 50%);
        background-attachment: fixed;
        font-family: 'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, sans-serif;
        color: #635167 !important;
    }

    /* Navigation & Executive Command Hero Header (#2B2543 Deep Twilight) */
    .command-hero-header {
        position: relative;
        background: linear-gradient(135deg, #2B2543 0%, #171528 100%) !important;
        padding: 2.4rem 3.2rem;
        border-radius: 20px;
        color: #FFFFFF !important;
        margin-bottom: 2rem;
        box-shadow: 0 12px 32px rgba(43, 37, 67, 0.2);
        border: 1.5px solid #62579B;
        overflow: hidden;
    }
    .command-hero-header::after {
        ...
        right: 0;
        height: 4px;
        background: linear-gradient(90deg, #62579B 0%, #7C86B3 50%, #2B2543 100%);
    }
    ...
    /* Popover Trigger Buttons (#2B2543 Navigation Style) */
    ...
    button[data-testid="stBaseButton-secondary"] {
        ...
        border: 1.5px solid #D5D8E9 !important;
        border-radius: 14px !important;
        box-shadow: 0 4px 14px rgba(43, 37, 67, 0.04) !important;
    ...
    button[data-testid="stPopoverButton"]:hover {
        ...
        border-color: #62579B !important;
        box-shadow: 0 8px 20px rgba(98, 87, 155, 0.15) !important;
    ...
    div[data-testid="column"]:nth-child(1) div[data-testid="stPopover"] > button { border-top: 4px solid #2B2543 !important; }
    div[data-testid="column"]:nth-child(2) div[data-testid="stPopover"] > button { border-top: 4px solid #62579B !important; }
    div[data-testid="column"]:nth-child(3) div[data-testid="stPopover"] > button { border-top: 4px solid #7C86B3 !important; }
    div[data-testid="column"]:nth-child(4) div[data-testid="stPopover"] > button { border-top: 4px solid #2B2543 !important; }
    ...
    div[data-testid="stPopoverBody"] {
        ...
        box-shadow: 0 12px 32px rgba(43, 37, 67, 0.15) !important;
        padding: 1.4rem !important;
    }

    /* CARDS (Palette 12 Multi-Color Accented Executive Glass Cards) */
    .metric-card-exec {
        border-radius: 16px !important;
        padding: 1.6rem 1.3rem !important;
        text-align: center !important;
        box-shadow: 0 4px 18px rgba(43, 37, 67, 0.05) !important;
        transition: all 0.25s ease !important;
    ...
    .metric-card-exec:hover {
        ...
        box-shadow: 0 10px 28px rgba(98, 87, 155, 0.18) !important;
    }

    /* 🟣 Card 1: Headcount (Deep Twilight Violet Accent) */
    .kpi-emerald {
        background: linear-gradient(135deg, #FFFFFF 55%, #E1E4F5 100%) !important;
        border: 1.5px solid #D5D8E9 !important;
        border-left: 7px solid #2B2543 !important;
    }
    .metric-val-emerald { font-size: 3.0rem !important; font-weight: 850 !important; color: #2B2543 !important; line-height: 1.05 !important; }
    .badge-bg-emerald { background: #2B2543 !important; color: #FFFFFF !important; border: 1px solid #2B2543 !important; }

    /* 🟣 Card 2: Active JDA / Joiners (Twilight Purple Accent) */
    .kpi-orange {
        background: linear-gradient(135deg, #FFFFFF 55%, #E5E1F5 100%) !important;
        border: 1.5px solid #D5D8E9 !important;
        border-left: 7px solid #62579B !important;
    }
    .metric-val-orange { font-size: 3.0rem !important; font-weight: 850 !important; color: #62579B !important; line-height: 1.05 !important; }
    .badge-bg-orange { background: #62579B !important; color: #FFFFFF !important; border: 1px solid #62579B !important; }

    /* 🔵 Card 3: Active ME / YoY (Twilight Slate Indigo Accent) */
    .kpi-blue {
        background: linear-gradient(135deg, #FFFFFF 55%, #E1E9F5 100%) !important;
        border: 1.5px solid #D5D8E9 !important;
        border-left: 7px solid #7C86B3 !important;
    }
    .metric-val-blue { font-size: 3.0rem !important; font-weight: 850 !important; color: #4A5482 !important; line-height: 1.05 !important; }
    .badge-bg-blue { background: #7C86B3 !important; color: #FFFFFF !important; border: 1px solid #7C86B3 !important; }

    /* 🟣 Card 4: Active TME / Exited (Twilight Amethyst Orchid Accent) */
    .kpi-rose {
        background: linear-gradient(135deg, #FFFFFF 55%, #EBE1F5 100%) !important;
        border: 1.5px solid #D5D8E9 !important;
        border-left: 7px solid #845EC2 !important;
    }
    .metric-val-rose { font-size: 3.0rem !important; font-weight: 850 !important; color: #6B40B2 !important; line-height: 1.05 !important; }
    .badge-bg-rose { background: #845EC2 !important; color: #FFFFFF !important; border: 1px solid #845EC2 !important; }

    /* 🔵 Card 5: MoM / QtQ Growth (Twilight Periwinkle Accent) */
    .kpi-cyan {
        background: linear-gradient(135deg, #FFFFFF 55%, #E1EFF5 100%) !important;
        border: 1.5px solid #D5D8E9 !important;
        border-left: 7px solid #5C6BC0 !important;
    }
    .metric-val-cyan { font-size: 3.0rem !important; font-weight: 850 !important; color: #3F51B5 !important; line-height: 1.05 !important; }
    .badge-bg-cyan { background: #5C6BC0 !important; color: #FFFFFF !important; border: 1px solid #5C6BC0 !important; }
    ...
    /* Custom Table Cards (#E1E4F5 with #D5D8E9 Borders) */
    .custom-table-card {
        background: #E1E4F5 !important;
        border-radius: 16px !important;
        padding: 1.4rem !important;
        border: 1.5px solid #D5D8E9 !important;
        box-shadow: 0 6px 20px rgba(43, 37, 67, 0.04) !important;
    ...
    .custom-table th {
        background: #2B2543 !important;
        color: #FFFFFF !important;
        font-weight: 800 !important;
        padding: 16px 20px !important;
        text-align: center !important;
        border-bottom: 2px solid #62579B !important;
        font-size: 1.1rem !important;
        text-transform: uppercase !important;
        letter-spacing: 0.5px !important;
    }
    ...
    .custom-table tr.total-row td {
        ...
        border-top: 2px solid #2B2543 !important;
    }

    /* Alternate Section (#EEEFFA) for Export Footer */
    .export-footer {
        background-color: #EEEFFA !important;
        border: 1.5px solid #D5D8E9;
        border-top: 4px solid #2B2543;
        border-radius: 20px;
        padding: 2.0rem 2.6rem;
        margin-top: 2.5rem;
        margin-bottom: 2rem;
        box-shadow: 0 10px 30px rgba(43, 37, 67, 0.05);
    }
    .export-title {
        font-size: 1.5rem;
        font-weight: 850;
    ...
    /* Primary & Secondary Buttons (#2B2543 & #62579B with #FFFFFF Text) */
    div[data-testid="stDownloadButton"] button {
        background: #2B2543 !important;
        color: #FFFFFF !important;
        border: 1.5px solid #2B2543 !important;
        border-radius: 14px !important;
        font-weight: 800 !important;
        padding: 10px 24px !important;
        box-shadow: 0 4px 12px rgba(43, 37, 67, 0.1) !important;
        transition: all 0.25s ease !important;
    }
    div[data-testid="stDownloadButton"] button:hover {
        background: #62579B !important;
        color: #FFFFFF !important;
        border-color: #62579B !important;
    }

    /* Parent Tabs (#2B2543 Primary Navigation) */
    .stTabs [role="tablist"],
    ...
    div[data-testid="stTabs"] [data-testid="stTab"] {
        ...
        box-shadow: 0 4px 14px rgba(43, 37, 67, 0.05) !important;
        transition: all 0.25s ease !important;
    }
    ...
    div[data-testid="stTabs"] button:hover * {
        background: #EEEFFA !important;
        background-color: #EEEFFA !important;
        color: #62579B !important;
        border-color: #62579B !important;
    }

    /* Active Parent Tab (#2B2543 Background with #FFFFFF Text) */
    ...
    div[data-testid="stTabs"] [data-testid="stTab"][aria-selected="true"] {
        background: #2B2543 !important;
        background-color: #2B2543 !important;
        border: 1.5px solid #2B2543 !important;
        border-radius: 16px !important;
        box-shadow: 0 8px 24px rgba(43, 37, 67, 0.25) !important;
    }
    ...
    /* Child Filter Segmented Control Bar (#2B2543 Track with #7C86B3 Active State) */
    .stTabs div[data-testid="stRadio"] div[role="radiogroup"] {
        ...
        border: 1px solid #171528 !important;
        margin-top: 4px !important;
        margin-bottom: 4px !important;
        width: fit-content !important;
        box-shadow: 0 2.5px 9px rgba(43, 37, 67, 0.2) !important;
    }
    ...
    /* Active State (#7C86B3 with #FFFFFF Text) */
    .stTabs div[data-testid="stRadio"] div[role="radiogroup"] label:has(input:checked) {
        background: #7C86B3 !important;
        background-color: #7C86B3 !important;
        color: #FFFFFF !important;
        font-weight: 850 !important;
        opacity: 1.0 !important;
        border-radius: 7.5px !important;
        padding: 5px 14px !important;
        border: 1px solid #7C86B3 !important;
        box-shadow: 0 2.5px 7px rgba(0, 0, 0, 0.15) !important;
    }
...
def render_download_section(section_id="default"):
    ...
    <div class="export-footer">
        ...
        <div style="font-size: 0.95rem; color: #635167; margin-bottom: 0.9rem; font-weight:600;">
    ...
    if df_filtered.empty:
        ...
        if s_mode == "📊 Pan India / Branch Summary":
            ...
            for _, r in br_hc_df_full.iterrows():
                ...
                html_b.append(f'<td style="font-weight:700; text-align:left; color:#171528;">{r["branch"]}</td>')
                html_b.append(f'<td style="color:#2B2543; font-weight:800;">{r["Active_Count"]}</td>')
                if not is_today:
                    html_b.append(f'<td style="color:#62579B; font-weight:700;">{r["Exited_Count"]}</td>')
                    html_b.append(f'<td style="color:#7C86B3; font-weight:800;">{r["New_Joiners_Count"]}</td>')
                html_b.append('</tr>')
            ...
            for _, r in team_hc_df_full.iterrows():
                ...
                html_t.append(f'<td style="font-weight:700; text-align:left; color:#171528;">{r["team_type"]}</td>')
                html_t.append(f'<td style="color:#2B2543; font-weight:800;">{r["Active_Count"]}</td>')
                if not is_today:
                    html_t.append(f'<td style="color:#62579B; font-weight:700;">{r["Exited_Count"]}</td>')
                    html_t.append(f'<td style="color:#7C86B3; font-weight:800;">{r["New_Joiners_Count"]}</td>')
                html_t.append('</tr>')
    ...
    if df_filtered.empty:
        ...
        if "Overall Tenure" in v_mode:
            ...
            for _, r in tb_df_full.iterrows():
                ...
                html_tb.append(f'<td style="font-weight:700; text-align:left; color:#171528;">{r["tenure_bucket"]}</td>')
                html_tb.append(f'<td style="color:#2B2543; font-weight:800;">{int(r["Total_Headcount"])}</td>')
                if not is_today:
                    html_tb.append(f'<td style="color:#62579B; font-weight:700;">{int(r["Exited_Count"])}</td>')
                html_tb.append('</tr>')
            ...
            for _, r in b_pivot_full.iterrows():
                ...
                html_bp.append(f'<td style="font-weight:700; text-align:left; color:#171528;">{r["branch"]}</td>')
            ...
            for _, r in t_pivot_full.iterrows():
                ...
                html_tp.append(f'<td style="font-weight:700; text-align:left; color:#171528;">{r["team_type"]}</td>')
    ...
    if d_mode == "🔍 Searchable Employee List":
        ...
        if display_df.empty:
            ...
            for _, r in display_df.head(100).iterrows():
                ...
                html5.append('<tr>')
                html5.append(f'<td style="font-weight:700; color:#2B2543;">{r["emp_code"]}</td>')
                html5.append(f'<td style="text-align:left; font-weight:700; color:#171528;">{r["emp_name"]}</td>')
                html5.append(f'<td style="color:#62579B;">{r["branch"]}</td>')
                ...
                html5.append(f'<td style="font-size:0.9rem; color:#635167;">{r["designation"]}</td>')
                html5.append('</tr>')
        ...
        if df_filtered.empty:
            ...
            for _, r in full_b_df.iterrows():
                ...
                html3.append(f'<td style="text-align:left; font-weight:700; color:#171528;">{r["branch"]}</td>')
                html3.append(f'<td style="color:#2B2543; font-weight:800;">{r["Active_Count"]}</td>')
                if not is_today: html3.append(f'<td style="color:#62579B; font-weight:700;">{r["Exited_Count"]}</td>')
                html3.append('</tr>')
        ...
        if df_filtered.empty:
            ...
            for _, r in full_t_df.iterrows():
                ...
                html4.append(f'<td style="text-align:left; font-weight:700; color:#171528;">{r["team_type"]}</td>')
                html4.append(f'<td style="color:#2B2543; font-weight:800;">{r["Active_Count"]}</td>')
                if not is_today: html4.append(f'<td style="color:#62579B; font-weight:700;">{r["Exited_Count"]}</td>')
                html4.append('</tr>')
        ...
        if is_today:
            ...
            if exited_df.empty:
                ...
                for _, r in exited_df.iterrows():
                    html_ex.append('<tr>')
                    html_ex.append(f'<td style="font-weight:700; color:#2B2543;">{r["emp_code"]}</td>')
                    html_ex.append(f'<td style="text-align:left; font-weight:700; color:#171528;">{r["emp_name"]}</td>')
                    ...
                    html_ex.append(f'<td style="color:#62579B; font-weight:800;">{r["dol"]}</td>')
                    html_ex.append(f'<td style="font-size:0.9rem; color:#635167;">{r["designation"]}</td>')
                    html_ex.append(f'<td style="font-size:0.85rem; color:#635167;">{r["email"]}</td>')
                    html_ex.append(f'<td style="font-size:0.85rem; color:#635167;">{r["phone"]}</td>')
                    html_ex.append('</tr>')
