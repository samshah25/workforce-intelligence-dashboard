...
st.set_page_config(
    page_title="Workforce Intelligence Command - Palette 14 (Port 8589)",
    page_icon="⚡",
    layout="wide",
    initial_sidebar_state="collapsed"
)

# Custom Palette 14 Color System (Port 8589 Updated Spec)
# Main background: #FAF9FB | Alternate section: #F0E8F4 | Cards: #E5D6EC | Main heading: #211A24
# Body text: #756F73 | Navigation: #4A2E56 | Primary button: #A56BBE | Button text: #FFFFFF
# Secondary button / Links: #7D438F | Borders: #D9C8E0 | Active state: #A56BBE
st.markdown("""
<style>
    ...
    .stApp {
        ...
        background-image: 
            radial-gradient(at 50% 0%, #F0E8F4 0%, transparent 75%),
            radial-gradient(at 0% 100%, #FAF9FB 0px, transparent 50%),
            radial-gradient(at 100% 100%, rgba(240, 232, 244, 0.6) 0px, transparent 50%);
        background-attachment: fixed;
        font-family: 'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, sans-serif;
        color: #756F73 !important;
    }

    /* Navigation & Executive Command Hero Header (#4A2E56 Deep Royal Plum Track) */
    .command-hero-header {
        position: relative;
        background: linear-gradient(135deg, #4A2E56 0%, #211A24 100%) !important;
        padding: 2.4rem 3.2rem;
        border-radius: 20px;
        color: #FFFFFF !important;
        margin-bottom: 2rem;
        box-shadow: 0 12px 32px rgba(74, 46, 86, 0.22);
        border: 1.5px solid #7D438F;
        overflow: hidden;
    }
    .command-hero-header::after {
        ...
        right: 0;
        height: 4px;
        background: linear-gradient(90deg, #A56BBE 0%, #7D438F 50%, #4A2E56 100%);
    }
    ...
    /* Popover Trigger Buttons (#FFFFFF with #D9C8E0 Border) */
    ...
    button[data-testid="stBaseButton-secondary"] {
        ...
        border: 1.5px solid #D9C8E0 !important;
        border-radius: 14px !important;
        box-shadow: 0 4px 14px rgba(74, 46, 86, 0.04) !important;
    ...
    button[data-testid="stPopoverButton"]:hover {
        ...
        border-color: #A56BBE !important;
        box-shadow: 0 8px 20px rgba(165, 107, 190, 0.18) !important;
    ...
    div[data-testid="column"]:nth-child(1) div[data-testid="stPopover"] > button { border-top: 4px solid #4A2E56 !important; }
    div[data-testid="column"]:nth-child(2) div[data-testid="stPopover"] > button { border-top: 4px solid #A56BBE !important; }
    div[data-testid="column"]:nth-child(3) div[data-testid="stPopover"] > button { border-top: 4px solid #7D438F !important; }
    div[data-testid="column"]:nth-child(4) div[data-testid="stPopover"] > button { border-top: 4px solid #4A2E56 !important; }
    ...
    div[data-testid="stPopoverBody"] {
        ...
        box-shadow: 0 12px 32px rgba(74, 46, 86, 0.15) !important;
        padding: 1.4rem !important;
    }

    /* CARDS (#E5D6EC Card Background with #D9C8E0 Borders & Soft Color Washes) */
    .metric-card-exec {
        border-radius: 16px !important;
        padding: 1.6rem 1.3rem !important;
        text-align: center !important;
        box-shadow: 0 4px 18px rgba(74, 46, 86, 0.05) !important;
        transition: all 0.25s ease !important;
    ...
    .metric-card-exec:hover {
        ...
        box-shadow: 0 10px 28px rgba(165, 107, 190, 0.18) !important;
    }

    /* 🟣 Card 1: Headcount (Deep Royal Plum Accent & Soft Tint) */
    .kpi-emerald {
        background: linear-gradient(135deg, #FFFFFF 55%, #E5D6EC 100%) !important;
        border: 1.5px solid #D9C8E0 !important;
        border-left: 7px solid #4A2E56 !important;
    }
    .metric-val-emerald { font-size: 3.0rem !important; font-weight: 850 !important; color: #4A2E56 !important; line-height: 1.05 !important; }
    .badge-bg-emerald { background: #4A2E56 !important; color: #FFFFFF !important; border: 1px solid #4A2E56 !important; }

    /* 🟣 Card 2: Active JDA / Joiners (Luminous Amethyst Purple Accent) */
    .kpi-orange {
        background: linear-gradient(135deg, #FFFFFF 55%, #F1DDF8 100%) !important;
        border: 1.5px solid #D9C8E0 !important;
        border-left: 7px solid #A56BBE !important;
    }
    .metric-val-orange { font-size: 3.0rem !important; font-weight: 850 !important; color: #A56BBE !important; line-height: 1.05 !important; }
    .badge-bg-orange { background: #A56BBE !important; color: #FFFFFF !important; border: 1px solid #A56BBE !important; }

    /* 🟣 Card 3: Active ME / YoY (Orchid Violet Accent) */
    .kpi-blue {
        background: linear-gradient(135deg, #FFFFFF 55%, #EAD4F2 100%) !important;
        border: 1.5px solid #D9C8E0 !important;
        border-left: 7px solid #7D438F !important;
    }
    .metric-val-blue { font-size: 3.0rem !important; font-weight: 850 !important; color: #7D438F !important; line-height: 1.05 !important; }
    .badge-bg-blue { background: #7D438F !important; color: #FFFFFF !important; border: 1px solid #7D438F !important; }

    /* 🍆 Card 4: Active TME / Exited (Deep Midnight Obsidian Accent - NON RED) */
    .kpi-rose {
        background: linear-gradient(135deg, #FFFFFF 55%, #E3D0E8 100%) !important;
        border: 1.5px solid #D9C8E0 !important;
        border-left: 7px solid #211A24 !important;
    }
    .metric-val-rose { font-size: 3.0rem !important; font-weight: 850 !important; color: #211A24 !important; line-height: 1.05 !important; }
    .badge-bg-rose { background: #211A24 !important; color: #FFFFFF !important; border: 1px solid #211A24 !important; }

    /* 🟣 Card 5: MoM / QtQ Growth (Luminous Amethyst Purple Accent) */
    .kpi-cyan {
        background: linear-gradient(135deg, #FFFFFF 55%, #F1DDF8 100%) !important;
        border: 1.5px solid #D9C8E0 !important;
        border-left: 7px solid #A56BBE !important;
    }
    .metric-val-cyan { font-size: 3.0rem !important; font-weight: 850 !important; color: #A56BBE !important; line-height: 1.05 !important; }
    .badge-bg-cyan { background: #A56BBE !important; color: #FFFFFF !important; border: 1px solid #A56BBE !important; }
    ...
    /* Custom Table Cards (#E5D6EC with #D9C8E0 Borders) */
    .custom-table-card {
        background: #E5D6EC !important;
        border-radius: 16px !important;
        padding: 1.4rem !important;
        border: 1.5px solid #D9C8E0 !important;
        box-shadow: 0 6px 20px rgba(74, 46, 86, 0.04) !important;
    ...
    .custom-table th {
        background: #4A2E56 !important;
        color: #FFFFFF !important;
        font-weight: 800 !important;
        padding: 16px 20px !important;
        text-align: center !important;
        border-bottom: 2px solid #A56BBE !important;
        font-size: 1.1rem !important;
        text-transform: uppercase !important;
        letter-spacing: 0.5px !important;
    }
    .custom-table td {
        ...
        text-align: center !important;
        border-bottom: 1px solid #D9C8E0 !important;
        color: #756F73 !important;
    ...
    .custom-table tr:hover td {
        background-color: #E5D6EC !important;
        color: #211A24 !important;
    }
    .custom-table tr.total-row td {
        ...
        border-top: 2px solid #4A2E56 !important;
    }

    /* Alternate Section (#F0E8F4) for Export Footer */
    .export-footer {
        background-color: #F0E8F4 !important;
        border: 1.5px solid #D9C8E0;
        border-top: 4px solid #A56BBE;
        border-radius: 20px;
        padding: 2.0rem 2.6rem;
        margin-top: 2.5rem;
        margin-bottom: 2rem;
        box-shadow: 0 10px 30px rgba(74, 46, 86, 0.05);
    }
    .export-title {
        font-size: 1.5rem;
        font-weight: 850;
    ...
    /* Secondary Button (#7D438F with #FFFFFF Text) */
    div[data-testid="stDownloadButton"] button {
        background: #7D438F !important;
        color: #FFFFFF !important;
        border: 1.5px solid #7D438F !important;
        border-radius: 14px !important;
        font-weight: 800 !important;
        padding: 10px 24px !important;
        box-shadow: 0 4px 12px rgba(125, 67, 143, 0.2) !important;
        transition: all 0.25s ease !important;
    }
    div[data-testid="stDownloadButton"] button:hover {
        background: #A56BBE !important;
        color: #FFFFFF !important;
        border-color: #A56BBE !important;
    }

    /* Navigation (#4A2E56 Track) */
    .stTabs [role="tablist"],
    ...
    div[data-testid="stTabs"] [data-testid="stTab"] {
        ...
        box-shadow: 0 4px 14px rgba(74, 46, 86, 0.05) !important;
        transition: all 0.25s ease !important;
    }
    ...
    div[data-testid="stTabs"] button:hover * {
        background: #F0E8F4 !important;
        background-color: #F0E8F4 !important;
        color: #A56BBE !important;
        border-color: #A56BBE !important;
    }

    /* Active Parent Tab (#A56BBE Primary Button Background with #FFFFFF Text) */
    ...
    div[data-testid="stTabs"] [data-testid="stTab"][aria-selected="true"] {
        background: #A56BBE !important;
        background-color: #A56BBE !important;
        border: 1.5px solid #A56BBE !important;
        border-radius: 16px !important;
        box-shadow: 0 8px 24px rgba(165, 107, 190, 0.3) !important;
    }
    ...
    /* Child Filter Segmented Control Bar (#4A2E56 Track with #A56BBE Active State) */
    .stTabs div[data-testid="stRadio"] div[role="radiogroup"] {
        ...
        border: 1px solid #4A2E56 !important;
        margin-top: 4px !important;
        margin-bottom: 4px !important;
        width: fit-content !important;
        box-shadow: 0 2.5px 9px rgba(74, 46, 86, 0.2) !important;
    }
    ...
    /* Active State (#A56BBE Amethyst Purple with #FFFFFF Text) */
    .stTabs div[data-testid="stRadio"] div[role="radiogroup"] label:has(input:checked) {
        ...
        border-radius: 7.5px !important;
        padding: 5px 14px !important;
        border: 1px solid #A56BBE !important;
        box-shadow: 0 2.5px 7px rgba(165, 107, 190, 0.3) !important;
    }
...
def render_download_section(section_id="default"):
    ...
    <div class="export-footer">
        ...
        <div style="font-size: 0.95rem; color: #756F73; margin-bottom: 0.9rem; font-weight:600;">
    ...
    if df_filtered.empty:
        ...
        if s_mode == "📊 Pan India / Branch Summary":
            ...
            for _, r in br_hc_df_full.iterrows():
                ...
                html_b.append(f'<td style="font-weight:700; text-align:left; color:#211A24;">{r["branch"]}</td>')
                html_b.append(f'<td style="color:#4A2E56; font-weight:800;">{r["Active_Count"]}</td>')
                if not is_today:
                    html_b.append(f'<td style="color:#7D438F; font-weight:700;">{r["Exited_Count"]}</td>')
                    html_b.append(f'<td style="color:#A56BBE; font-weight:800;">{r["New_Joiners_Count"]}</td>')
                html_b.append('</tr>')
            ...
            for _, r in team_hc_df_full.iterrows():
                ...
                html_t.append(f'<td style="font-weight:700; text-align:left; color:#211A24;">{r["team_type"]}</td>')
                html_t.append(f'<td style="color:#4A2E56; font-weight:800;">{r["Active_Count"]}</td>')
                if not is_today:
                    html_t.append(f'<td style="color:#7D438F; font-weight:700;">{r["Exited_Count"]}</td>')
                    html_t.append(f'<td style="color:#A56BBE; font-weight:800;">{r["New_Joiners_Count"]}</td>')
                html_t.append('</tr>')
    ...
    if df_filtered.empty:
        ...
        if "Overall Tenure" in v_mode:
            ...
            for _, r in tb_df_full.iterrows():
                ...
                html_tb.append(f'<td style="font-weight:700; text-align:left; color:#211A24;">{r["tenure_bucket"]}</td>')
                html_tb.append(f'<td style="color:#4A2E56; font-weight:800;">{int(r["Total_Headcount"])}</td>')
                if not is_today:
                    html_tb.append(f'<td style="color:#7D438F; font-weight:700;">{int(r["Exited_Count"])}</td>')
                html_tb.append('</tr>')
            ...
            for _, r in b_pivot_full.iterrows():
                ...
                html_bp.append(f'<td style="font-weight:700; text-align:left; color:#211A24;">{r["branch"]}</td>')
            ...
            for _, r in t_pivot_full.iterrows():
                ...
                html_tp.append(f'<td style="font-weight:700; text-align:left; color:#211A24;">{r["team_type"]}</td>')
    ...
    if d_mode == "🔍 Searchable Employee List":
        ...
        if display_df.empty:
            ...
            for _, r in display_df.head(100).iterrows():
                ...
                html5.append('<tr>')
                html5.append(f'<td style="font-weight:700; color:#4A2E56;">{r["emp_code"]}</td>')
                html5.append(f'<td style="text-align:left; font-weight:700; color:#211A24;">{r["emp_name"]}</td>')
                html5.append(f'<td style="color:#7D438F;">{r["branch"]}</td>')
                ...
                html5.append(f'<td style="font-size:0.9rem; color:#756F73;">{r["designation"]}</td>')
                html5.append('</tr>')
        ...
        if df_filtered.empty:
            ...
            for _, r in full_b_df.iterrows():
                ...
                html3.append(f'<td style="text-align:left; font-weight:700; color:#211A24;">{r["branch"]}</td>')
                html3.append(f'<td style="color:#4A2E56; font-weight:800;">{r["Active_Count"]}</td>')
                if not is_today: html3.append(f'<td style="color:#7D438F; font-weight:700;">{r["Exited_Count"]}</td>')
                html3.append('</tr>')
        ...
        if df_filtered.empty:
            ...
            for _, r in full_t_df.iterrows():
                ...
                html4.append(f'<td style="text-align:left; font-weight:700; color:#211A24;">{r["team_type"]}</td>')
                html4.append(f'<td style="color:#4A2E56; font-weight:800;">{r["Active_Count"]}</td>')
                if not is_today: html4.append(f'<td style="color:#7D438F; font-weight:700;">{r["Exited_Count"]}</td>')
                html4.append('</tr>')
        ...
        if is_today:
            ...
            if exited_df.empty:
                ...
                for _, r in exited_df.iterrows():
                    html_ex.append('<tr>')
                    html_ex.append(f'<td style="font-weight:700; color:#4A2E56;">{r["emp_code"]}</td>')
                    html_ex.append(f'<td style="text-align:left; font-weight:700; color:#211A24;">{r["emp_name"]}</td>')
                    ...
                    html_ex.append(f'<td style="color:#7D438F; font-weight:800;">{r["dol"]}</td>')
                    html_ex.append(f'<td style="font-size:0.9rem; color:#756F73;">{r["designation"]}</td>')
                    html_ex.append(f'<td style="font-size:0.85rem; color:#756F73;">{r["email"]}</td>')
                    html_ex.append(f'<td style="font-size:0.85rem; color:#756F73;">{r["phone"]}</td>')
                    html_ex.append('</tr>')
