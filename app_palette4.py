...
# Cool Executive Light Theme Design System (Color Palette 4)
st.markdown("""
<style>
    ...
    .stApp {
        ...
        background-image: 
            radial-gradient(at 50% 0%, #DCEBFF 0%, transparent 75%),
            radial-gradient(at 0% 100%, #F8FAFD 0px, transparent 50%),
            radial-gradient(at 100% 100%, rgba(220, 235, 255, 0.5) 0px, transparent 50%);
    ...
    .command-hero-header {
        background: linear-gradient(135deg, #1D4FB5 0%, #2563D9 50%, #1D4FB5 100%);
        padding: 2.2rem 3rem;
        border-radius: 24px;
        color: #FFFFFF;
        margin-bottom: 2rem;
        box-shadow: 0 16px 40px rgba(37, 99, 217, 0.25);
    ...
    button[data-testid="stBaseButton-secondary"] {
        ...
        box-shadow: 0 6px 18px rgba(23, 35, 61, 0.06) !important;
    ...
    button[data-testid="stPopoverButton"]:hover {
        ...
        box-shadow: 0 10px 24px rgba(37, 99, 217, 0.18) !important;
    ...
    div[data-testid="column"]:nth-child(1) div[data-testid="stPopover"] > button {
        border-top: 5px solid #2563D9 !important;
    }
    div[data-testid="column"]:nth-child(2) div[data-testid="stPopover"] > button {
        border-top: 5px solid #1D4FB5 !important;
    }
    ...
    div[data-testid="stPopoverBody"] {
        ...
        box-shadow: 0 16px 40px rgba(23, 35, 61, 0.15) !important;
    ...
    .period-chip {
        ...
        box-shadow: 0 4px 12px rgba(37, 99, 217, 0.12) !important;
    }
    ...
    div[data-testid="stSelectbox"] > div {
        ...
        border: 1.5px solid #D6E0EF !important;
        border-radius: 14px !important;
        box-shadow: 0 4px 12px rgba(23, 35, 61, 0.04) !important;
        transition: all 0.22s ease !important;
    }
    div[data-testid="stSelectbox"] > div:hover {
        border-color: #3B82F6 !important;
        box-shadow: 0 6px 18px rgba(37, 99, 217, 0.15) !important;
    }
    ...
    /* KPI Cards Styling (#FFFFFF Card Background) */
    .metric-card-exec {
        background: #FFFFFF !important;
        border-radius: 22px;
        padding: 1.4rem 1.1rem;
        text-align: center;
        box-shadow: 0 10px 28px rgba(23, 35, 61, 0.08), 0 0 20px rgba(37, 99, 217, 0.05);
    ...
    .metric-card-exec:hover {
        ...
        box-shadow: 0 16px 36px rgba(37, 99, 217, 0.18), 0 0 30px rgba(59, 130, 246, 0.15);
        border-color: #3B82F6;
    }
    ...
    /* 🟢 Headcount (Primary Blue Highlight) */
    .kpi-emerald {
        background: #FFFFFF !important;
        border-color: #D6E0EF;
    }
    .kpi-emerald::before { background: linear-gradient(90deg, #1D4FB5, #2563D9); }
    .metric-val-emerald { font-size: 2.3rem; font-weight: 800; color: #2563D9; line-height: 1.1; }
    .badge-bg-emerald { background: #DCEBFF; color: #1D4FB5; border: 1px solid #3B82F6; }

    /* 🟧 Active JDA / QtQ % (Deep Blue) */
    .kpi-orange {
        background: #FFFFFF !important;
        border-color: #D6E0EF;
    }
    .kpi-orange::before { background: linear-gradient(90deg, #2563D9, #3B82F6); }
    .metric-val-orange { font-size: 2.3rem; font-weight: 800; color: #1D4FB5; line-height: 1.1; }
    .badge-bg-orange { background: #DCEBFF; color: #1D4FB5; border: 1px solid #3B82F6; }

    /* 🟦 Active ME / YoY % (Primary Blue) */
    .kpi-blue {
        background: #FFFFFF !important;
        border-color: #D6E0EF;
    }
    .kpi-blue::before { background: linear-gradient(90deg, #1D4FB5, #2563D9); }
    .metric-val-blue { font-size: 2.3rem; font-weight: 800; color: #2563D9; line-height: 1.1; }
    .badge-bg-blue { background: #DCEBFF; color: #1D4FB5; border: 1px solid #3B82F6; }

    /* 🔴 Active TME / Exited (Crimson Alert Accent) */
    .kpi-rose {
        background: #FFFFFF !important;
        border-color: #D6E0EF;
    }
    ...
    .kpi-cyan::before { background: linear-gradient(90deg, #2563D9, #3B82F6); }
    .metric-val-cyan { font-size: 2.3rem; font-weight: 800; color: #1D4FB5; line-height: 1.1; }
    .badge-bg-cyan { background: #DCEBFF; color: #1D4FB5; border: 1px solid #3B82F6; }
    ...
    .custom-table-card {
        ...
        padding: 1.6rem;
        border: 1.5px solid #D6E0EF;
        box-shadow: 0 10px 30px rgba(23, 35, 61, 0.08);
        margin-bottom: 2rem;
        overflow-x: auto;
    }
    .custom-table {
    ...
    .custom-table th {
        background: linear-gradient(135deg, #1D4FB5 0%, #2563D9 100%) !important;
    ...
    .custom-table tr:nth-child(even) td {
        background-color: #F1F5FB !important; /* Alternate row */
    }
    .custom-table tr:hover td {
        background-color: #E8F0FC !important; /* Hover row */
        color: #17233D !important;
    }
    .custom-table tr.total-row td {
        background: linear-gradient(135deg, #2563D9 0%, #3B82F6 100%) !important;
        color: #FFFFFF !important;
        font-weight: 800 !important;
        font-size: 1.05rem !important;
    }
    ...
    /* Main Tab Navigation Bar (#FFFFFF Track) */
    ...
    .stTabs div[data-baseweb="tab"][aria-selected="true"] span {
        color: #FFFFFF !important;
        background: linear-gradient(135deg, #2563D9 0%, #1D4FB5 100%) !important;
        border-radius: 16px !important;
        box-shadow: 0 8px 22px rgba(37, 99, 217, 0.3) !important;
        border-bottom: none !important;
        font-weight: 800 !important;
    }
    ...
    /* Integrated Parent-Child Sub-View Segmented Control Bar (#F1F5FB) */
    .stTabs div[data-testid="stRadio"] div[role="radiogroup"] {
        ...
        box-shadow: inset 0 2px 4px rgba(23, 35, 61, 0.04) !important;
    }
    ...
    .stTabs div[data-testid="stRadio"] div[role="radiogroup"] label:hover p,
    .stTabs div[data-testid="stRadio"] div[role="radiogroup"] label:hover span {
        color: #2563D9 !important;
    ...
    .stTabs div[data-testid="stRadio"] div[role="radiogroup"] label:has(input:checked) span {
        ...
        font-weight: 800 !important;
        border-radius: 12px !important;
        box-shadow: 0 4px 14px rgba(37, 99, 217, 0.25) !important;
    }
</style>
...
<script>
    (function() {
        try {
            ...
            var styleId = 'custom-smooth-scroll-style-p4';
            ...
            if (!targetDoc._hasExpanderPersistListenerP4) {
                targetDoc._hasExpanderPersistListenerP4 = true;
...
def render_download_section(section_id="default"):
    ...
    <div class="export-footer">
        ...
        <div style="font-size: 0.92rem; color: #1D4FB5; margin-bottom: 0.9rem; font-weight:600;">
    ...
    if df_filtered.empty:
        ...
        if s_mode == "📊 Pan India / Branch Summary":
            ...
            for _, r in br_hc_df.iterrows():
                html_b.append('<tr>')
                html_b.append(f'<td style="font-weight:700; text-align:left; color:#1D4FB5;">{r["branch"]}</td>')
                ...
                html_b.append(f'<td style="color:#2563D9; font-weight:800;">{r["Active_Pct"]}</td>')
                html_b.append('</tr>')
            ...
            for _, r in team_hc_df.iterrows():
                html_t.append('<tr>')
                html_t.append(f'<td style="font-weight:700; text-align:left; color:#1D4FB5;">{r["team_type"]}</td>')
                ...
                html_t.append(f'<td style="color:#2563D9; font-weight:800;">{r["Active_Pct"]}</td>')
                html_t.append('</tr>')
    ...
    if df_filtered.empty:
        ...
        if v_mode == "⏳ Overall Tenure Buckets":
            ...
            for _, r in tb_df.iterrows():
                html_tb.append('<tr>')
                html_tb.append(f'<td style="font-weight:700; text-align:left; color:#1D4FB5;">{r["tenure_bucket"]}</td>')
                ...
                html_tb.append(f'<td style="color:#2563D9; font-weight:800;">{r["Active_Pct"]}</td>')
                html_tb.append('</tr>')
            ...
            for _, r in b_pivot.iterrows():
                html_bp.append('<tr>')
                html_bp.append(f'<td style="font-weight:700; text-align:left; color:#1D4FB5;">{r["branch"]}</td>')
                for bo in bucket_order:
                    html_bp.append(f'<td>{r[bo]}</td>')
                html_bp.append(f'<td style="font-weight:800; color:#2563D9;">{r["Headcount"]}</td>')
                html_bp.append('</tr>')
            ...
            for _, r in t_pivot.iterrows():
                html_tp.append('<tr>')
                html_tp.append(f'<td style="font-weight:700; text-align:left; color:#1D4FB5;">{r["team_type"]}</td>')
                for bo in bucket_order:
                    html_tp.append(f'<td>{r[bo]}</td>')
                html_tp.append(f'<td style="font-weight:800; color:#2563D9;">{r["Headcount"]}</td>')
                html_tp.append('</tr>')
    ...
    if d_mode == "🔍 Searchable Employee List":
        ...
        if display_df.empty:
            ...
            for _, r in display_df.head(100).iterrows():
                ...
                html5.append('<tr>')
                html5.append(f'<td style="font-weight:700; color:#2563D9;">{r["emp_code"]}</td>')
                html5.append(f'<td style="text-align:left; font-weight:700; color:#17233D;">{r["emp_name"]}</td>')
                html5.append(f'<td style="color:#1D4FB5;">{r["branch"]}</td>')
                ...
                html5.append(f'<td style="font-size:0.9rem; color:#52627A;">{r["designation"]}</td>')
                html5.append('</tr>')
        ...
        if df_filtered.empty:
            ...
            for _, r in full_b_df.iterrows():
                ...
                html3.append(f'<td style="text-align:left; font-weight:700; color:#1D4FB5;">{r["Branch / City"]}</td>')
                ...
                html3.append(f'<td style="font-weight:800; color:#2563D9;">{r["Exact Avg Tenure (Months)"]} M</td>')
        ...
        if df_filtered.empty:
            ...
            for _, r in full_t_df.iterrows():
                ...
                html4.append(f'<td style="text-align:left; font-weight:700; color:#1D4FB5;">{r["Team Type"]}</td>')
                ...
                html4.append(f'<td style="font-weight:800; color:#2563D9;">{r["Exact Avg Tenure (Months)"]} M</td>')
        ...
        if exited_df.empty:
            ...
            for _, r in exited_df.iterrows():
                ...
                html_ex.append(f'<td style="text-align:left; font-weight:700; color:#17233D;">{r["emp_name"]}</td>')
                ...
                html_ex.append(f'<td style="font-weight:800; color:#2563D9;">{r["tenure_months"]} M</td>')
                html_ex.append(f'<td>{r["tenure_years"]} Yrs</td>')
                html_ex.append(f'<td style="font-size:0.9rem; color:#52627A;">{r["designation"]}</td>')
